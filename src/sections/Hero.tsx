...
const floatingTerms = [
  ...
  "Firebase", "GraphQL", "Docker", "AWS", "Python", "Figma",
  "Material UI", "Vue.js", "Angular", "Java", "Photoshop", "Lightroom"
];
...
const MatrixWord = ({ word, delay }: { word: string, delay: number }) => {
  ...
  return (
    <motion.span
      className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-violet-500 to-indigo-500"
      style={{
        textShadow: isAnimating ? '0 0 15px rgba(139, 92, 246, 0.7)' : '0 0 5px rgba(139, 92, 246, 0.3)', 
        transition: 'text-shadow 0.3s ease',
        fontFamily: "'OnePlus Sans', sans-serif",
        fontWeight: 700,  // Changed from 500 to 700 (bold weight)
...
const SocialLinks = () => {
  return (
    <div className="flex items-center gap-4 mt-8">
      <a href="https://github.com/xombi17" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
      ...
      <a href="https://www.linkedin.com/in/varad-amit-joshi/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
        </svg>
      </a>
      <a href="mailto:varadaj47@gmail.com" className="text-gray-400 hover:text-white transition-colors">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="grid md:grid-cols-12 items-center gap-8 md:gap-16">
          ...
          >
            <div className="relative">
              ...
              {/* Tech floating elements - ENHANCED with more elements */}
              <motion.div 
              ...
              <motion.div 
                className="absolute top-1/4 -left-16 px-3 py-2 bg-red-900/30 backdrop-blur-sm rounded text-xs text-red-300 border border-red-700/30 shadow-lg"
                animate={{ 
                  x: [0, -8, 0],
                  y: [0, -5, 0],
                }}
              ...
              <motion.div 
                className="absolute bottom-1/4 -right-14 px-3 py-2 bg-green-900/30 backdrop-blur-sm rounded text-xs text-green-300 border border-green-700/30 shadow-lg"
                animate={{ 
                  x: [0, 8, 0],
                  y: [0, 8, 0],
                }}
              ...
              <motion.div 
                className="absolute top-3/4 -right-12 px-3 py-2 bg-yellow-900/30 backdrop-blur-sm rounded text-xs text-yellow-300 border border-yellow-700/30 shadow-lg"
                animate={{ 
                  x: [0, 5, 0],
                  rotate: [0, 3, 0],
                }}
